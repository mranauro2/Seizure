...
def parse_arguments() -> tuple[str|None, list[str], str, str|None, int, bool, int, bool, str|None]:
    """
    ...
    return args.input_dir, args.files_record, args.method, args.scaler, args.save_num, args.train, args.epochs, args.verbose, preprocess_dir
